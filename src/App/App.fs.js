...
export function view() {
    return Html_div([style([CssEngine_CssEngine$1__fontFamily_4E60E31B(Css, "Arial, Helvetica,sans-serif"), CssEngine_CssEngine$1__textAlign_4E60E31B(Css, "center"), CssEngine_CssEngine$1__marginTop_4E60E31B(Css, "40px"), CssEngine_CssEngine$1__fontSize_4E60E31B(Css, "10ex")]), text("Hello World 2 Cool :)!")]);
}
